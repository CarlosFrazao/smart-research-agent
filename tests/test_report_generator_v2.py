...
async def test_report_generator_v2_confidence_annotations():
    ...
    mock_llm.generate = pytest.importorskip("unittest.mock").AsyncMock(
    ...
    r1 = SynthesizedResult(
        ...
        combined_score=85.0,
        metrics={"stars": 120, "dead_links": ["https://badsite.com/broken-url"]},
    ...
    assert (
        "🚫 **Alertas:** Conteúdo Desatualizado, Links Quebrados Detectados" in report
    )
