...
def get_metrics() -> Dict[str, Any]:
    ...
    if _metrics is None:
        try:
            ...
            logger.warning("prometheus-client não está instalado. Métricas desabilitadas.")
            _metrics = {}
    return _metrics
...
def start_metrics_server(port: int = 8001) -> None:
    ...
    try:
        ...
        logger.warning("Falha ao subir Metrics Server (prometheus-client não instalado).")
