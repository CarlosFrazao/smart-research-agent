...
class MultiLLMFactChecker:
    ...
    async def _call_llm(self, llm: Any, prompt: str) -> Optional[Dict[str, Any]]:
    ...
    async def verify_claim(self, claim: str, evidence: Optional[List[str]] = None) -> FactCheckResult:
    ...
    async def verify_batch(self, claims: List[str], evidence: Optional[List[str]] = None,
